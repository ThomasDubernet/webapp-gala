 ...
 */
final class Version20211214095908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, plan_id INT DEFAULT NULL, image_ticket_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, nom_salle VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B26681EE899029B (plan_id), UNIQUE INDEX UNIQ_B26681EA8829C86 (image_ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
