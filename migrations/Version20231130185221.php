 ...
 */
final class Version20231130185221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE civilite (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, plan_id INT DEFAULT NULL, image_ticket_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, nom_salle VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, text_email LONGTEXT DEFAULT NULL, billetweb_id VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B26681EE899029B (plan_id), UNIQUE INDEX UNIQ_B26681EA8829C86 (image_ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, table_id INT DEFAULT NULL, conjoint_id INT DEFAULT NULL, civilite_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, montant_billet NUMERIC(6, 2) DEFAULT NULL, montant_paye NUMERIC(6, 2) DEFAULT NULL, date_reglement DATETIME DEFAULT NULL, moyen_paiement VARCHAR(255) DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, present TINYINT(1) DEFAULT NULL, id_cerfa VARCHAR(255) DEFAULT NULL, mail_envoye TINYINT(1) DEFAULT NULL, INDEX IDX_FCEC9EFBCF5E72D (categorie_id), INDEX IDX_FCEC9EFECFF285C (table_id), UNIQUE INDEX UNIQ_FCEC9EF5E8D7836 (conjoint_id), INDEX IDX_FCEC9EF39194ABF (civilite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `table` (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, numero INT NOT NULL, nombre_places_max INT NOT NULL, pos_x NUMERIC(6, 2) DEFAULT NULL, pos_y NUMERIC(6, 2) DEFAULT NULL, INDEX IDX_F6298F46BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE personne ADD CONSTRAINT FK_FCEC9EF39194ABF FOREIGN KEY (civilite_id) REFERENCES civilite (id)');
        $this->addSql('ALTER TABLE `table` ADD CONSTRAINT FK_F6298F46BCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie_table (id)');
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA3A21BD112 FOREIGN KEY (personne_id) REFERENCES personne (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP FOREIGN KEY FK_FCEC9EF39194ABF');
