 ...
 */
final class Version20211217074520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, table_id INT DEFAULT NULL, conjoint_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, montant_billet NUMERIC(6, 2) DEFAULT NULL, montant_paye NUMERIC(6, 2) DEFAULT NULL, date_reglement DATETIME DEFAULT NULL, moyen_paiement VARCHAR(255) DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, present TINYINT(1) DEFAULT NULL, civilite VARCHAR(255) NOT NULL, INDEX IDX_FCEC9EFBCF5E72D (categorie_id), INDEX IDX_FCEC9EFECFF285C (table_id), UNIQUE INDEX UNIQ_FCEC9EF5E8D7836 (conjoint_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
