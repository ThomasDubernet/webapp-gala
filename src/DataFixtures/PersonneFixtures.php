...
class PersonneFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $personne->setAdresse('3 rue jean jaures, 33810 Ambès');
        ...
        $personne2->setAdresse('2( rue de la paix, 33000 Bordeaux');
        ...
        $personne3->setAdresse('36 rue de la foret, 33000 Bordeaux');
